      ...
      <div className='main-container'>
        <div className='content-container'>
          <div className='form-container'>
            <h1>Welcome to Skin Club</h1>
            <p>Don’t have an account? <a href='/' style={{color:'#4C4D4F'}}> Sign up</a></p>
            ...
            <form className='form'>
                            ...
                            <div className='password'>
                                ...
                                <span style={{marginTop:'.8rem', textAlign:'end'}}><a style={{color:'rgba(76, 77, 79, 0.50)', fontSize:'12px'}} href='/forgotpassword'>Forgot your password</a></span>
                            </div>
                            ...
                            <div className='login-page'>
                                <Link className='button' to="/overview">Log in</Link>
                            </div>
                            <p style={{textAlign:'center', paddingTop:'.8rem'}}>Don’t have an account?<a href='./' style={{color:'#4C4D4F'}}>  Sign up</a></p>
                        </form>
                        <span class="line">
                            <h2>Or</h2>
                        </span>
